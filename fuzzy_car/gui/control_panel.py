...
class ControlFrame(QFrame):
    ...
    def __set_running_options_ui(self):
        group_box = QGroupBox("Jenis Trek Mobil")
        ...
        self.start_btn.setStatusTip("Menjalankan Mobil")
        self.start_btn.clicked.connect(self.__run)

        self.stop_btn = QPushButton("Stop")
        self.stop_btn.setStatusTip("Menghentikan Mobil")
        self.stop_btn.setDisabled(True)

        self.save_btn = QPushButton()
        self.save_btn.setIcon(QIcon(':/icons/save_icon.png'))
        self.save_btn.setStatusTip("Menyimpan File "
                                   "running.")
    ...
    def __set_fuzzy_variables_ui(self):
        group_box = QGroupBox("Pengaturan Variable Fuzzy")
        ...
        self.fuzzyvar_ui_selection = RadioButtonSet([
            ("front", QRadioButton("Radar Depan")),
            ("lrdiff", QRadioButton("(Kiri-Kanan) Radar")),
            ("consequence", QRadioButton("Kosekuensi"))
        ])
    ...
    def __set_fuzzy_rules_ui(self):
        ...
        group_box = QGroupBox("Pengaturan Rule Fuzzy")
        inner_layout = QVBoxLayout()
